...
import de.MiningPickaxe.crafting.compressorCraftingManager;
...
public class Containercompressor extends Container {
	...
	public Containercompressor(InventoryPlayer invPlayer, World world, int x, int y, int z) {
	...
	public void onCraftMatrixChanged(IInventory iiventory) {
		craftResult.setInventorySlotContents(0, compressorCraftingManager.getInstance().findMatchingRecipe(craftMatrix, worldObj));
	...
	public boolean canInteractWith(EntityPlayer player) {
		if(worldObj.getBlock(posX, posY, posZ) != compress.compressor) {
			return false;
		}else{
